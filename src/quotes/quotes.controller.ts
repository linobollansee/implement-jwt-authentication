...
export class QuotesController {
  ...
  // @UseGuards - applies JwtAuthGuard and RolesGuard to protect this route
  // @UseGuards - wendet JwtAuthGuard und RolesGuard an, um diese Route zu schützen
  // @Roles - requires 'admin' or 'user' role to create quotes
  // @Roles - erfordert 'admin'- oder 'user'-Rolle zum Erstellen von Zitaten
  ...
  // @UseGuards - applies JwtAuthGuard and RolesGuard to protect this route
  // @UseGuards - wendet JwtAuthGuard und RolesGuard an, um diese Route zu schützen
  // @Roles - requires 'admin' role to update quotes
  // @Roles - erfordert 'admin'-Rolle zum Aktualisieren von Zitaten
  @UseGuards(JwtAuthGuard, RolesGuard)
  @Roles("admin")
  @Put(":id")
  async update(
  ...
  // @UseGuards - applies JwtAuthGuard and RolesGuard to protect this route
  // @UseGuards - wendet JwtAuthGuard und RolesGuard an, um diese Route zu schützen
  // @Roles - requires 'admin' role to delete quotes
  // @Roles - erfordert 'admin'-Rolle zum Löschen von Zitaten
  @UseGuards(JwtAuthGuard, RolesGuard)
  @Roles("admin")
  @Delete(":id")
  async remove(
