...
// Import AuthModule - handles authentication and JWT
// AuthModule importieren - behandelt Authentifizierung und JWT
...
@Module({
  ...
  imports: [
    ...
    // AuthModule für Authentifizierungs-Funktionalität importieren
    AuthModule,
  ],
})
